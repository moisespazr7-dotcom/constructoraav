...
@section('content')
<div class="card">
    <div class="section-title">Solicitudes de materiales</div>
    <form class="filters" method="GET" action="{{ route('admin.materials.index') }}">
        ...
        <div style="min-width: 240px; flex:1;">
            <input class="input" name="q" value="{{ request('q') }}" placeholder="Buscar por nombre, telefono o material">
        </div>
    ...
    <table class="table">
        ...
        @forelse ($items as $item)
            <tr>
                ...
                <td>
                    <form class="actions" method="POST" action="{{ route('admin.materials.update', $item) }}">
                        @csrf
                        @method('PATCH')
                    ...
                    <form method="POST" action="{{ route('admin.materials.destroy', $item) }}" style="margin-top:8px;">
                        @csrf
                        @method('DELETE')
